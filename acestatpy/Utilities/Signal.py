...
Modified by Jesse M. Barr 2021-04-21
"""
...
class Signal(object):
    ...
    def connect(self, handler, weak=None):
        ...
        if weak is None:
            if _islambda(handler):
                ...
                weak = True
        dispatcher.connect(receiver=handler, signal=self._name, sender=self, weak=weak)
    ...
    def emit(self, *args, **kwargs):
        ...
        """
        dispatcher.send(self._name, self, *args, **kwargs)
